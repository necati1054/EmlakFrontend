...
export const türkiyeIlleri = [
  [
    { text: "seç", value: "seç" },
    { text: "ADANA", value: "ADANA" },
    { text: "ADIYAMAN", value: "ADIYAMAN" },
    { text: "AFYONKARAHİSAR", value: "AFYONKARAHİSAR" },
    { text: "AĞRI", value: "AĞRI" },
    { text: "AMASYA", value: "AMASYA" },
    { text: "ANKARA", value: "ANKARA" },
    { text: "ANTALYA", value: "ANTALYA" },
    { text: "ARTVİN", value: "ARTVİN" },
    { text: "AYDIN", value: "AYDIN" },
    { text: "BALIKESİR", value: "BALIKESİR" },
    { text: "BİLECİK", value: "BİLECİK" },
    { text: "BİNGÖL", value: "BİNGÖL" },
    { text: "BİTLİS", value: "BİTLİS" },
    { text: "BOLU", value: "BOLU" },
    { text: "BURDUR", value: "BURDUR" },
    { text: "BURSA", value: "BURSA" },
    { text: "ÇANAKKALE", value: "ÇANAKKALE" },
    { text: "ÇANKIRI", value: "ÇANKIRI" },
    { text: "ÇORUM", value: "ÇORUM" },
    { text: "DENİZLİ", value: "DENİZLİ" },
    { text: "DİYARBAKIR", value: "DİYARBAKIR" },
    { text: "EDİRNE", value: "EDİRNE" },
    { text: "ELAZIĞ", value: "ELAZIĞ" },
    { text: "ERZİNCAN", value: "ERZİNCAN" },
    { text: "ERZURUM", value: "ERZURUM" },
    { text: "ESKİŞEHİR", value: "ESKİŞEHİR" },
    { text: "GAZİANTEP", value: "GAZİANTEP" },
    { text: "GİRESUN", value: "GİRESUN" },
    { text: "GÜMÜŞHANE", value: "GÜMÜŞHANE" },
    { text: "HAKKARİ", value: "HAKKARİ" },
    { text: "HATAY", value: "HATAY" },
    { text: "ISPARTA", value: "ISPARTA" },
    { text: "MERSİN", value: "MERSİN" },
    { text: "İSTANBUL", value: "İSTANBUL" },
    { text: "İZMİR", value: "İZMİR" },
    { text: "KARS", value: "KARS" },
    { text: "KASTAMONU", value: "KASTAMONU" },
    { text: "KAYSERİ", value: "KAYSERİ" },
    { text: "KIRKLARELİ", value: "KIRKLARELİ" },
    { text: "KIRŞEHİR", value: "KIRŞEHİR" },
    { text: "KOCAELİ", value: "KOCAELİ" },
    { text: "KONYA", value: "KONYA" },
    { text: "KÜTAHYA", value: "KÜTAHYA" },
    { text: "MALATYA", value: "MALATYA" },
    { text: "MANİSA", value: "MANİSA" },
    { text: "KAHRAMANMARAŞ", value: "KAHRAMANMARAŞ" },
    { text: "MARDİN", value: "MARDİN" },
    { text: "MUĞLA", value: "MUĞLA" },
    { text: "MUŞ", value: "MUŞ" },
    { text: "NEVŞEHİR", value: "NEVŞEHİR" },
    { text: "NİĞDE", value: "NİĞDE" },
    { text: "ORDU", value: "ORDU" },
    { text: "RİZE", value: "RİZE" },
    { text: "SAKARYA", value: "SAKARYA" },
    { text: "SAMSUN", value: "SAMSUN" },
    { text: "SİİRT", value: "SİİRT" },
    { text: "SİNOP", value: "SİNOP" },
    { text: "SİVAS", value: "SİVAS" },
    { text: "TEKİRDAĞ", value: "TEKİRDAĞ" },
    { text: "TOKAT", value: "TOKAT" },
    { text: "TRABZON", value: "TRABZON" },
    { text: "TUNCELİ", value: "TUNCELİ" },
    { text: "ŞANLIURFA", value: "ŞANLIURFA" },
    { text: "UŞAK", value: "UŞAK" },
    { text: "VAN", value: "VAN" },
    { text: "YOZGAT", value: "YOZGAT" },
    { text: "ZONGULDAK", value: "ZONGULDAK" },
    { text: "AKSARAY", value: "AKSARAY" },
    { text: "BAYBURT", value: "BAYBURT" },
    { text: "KARAMAN", value: "KARAMAN" },
    { text: "KIRIKKALE", value: "KIRIKKALE" },
    { text: "BATMAN", value: "BATMAN" },
    { text: "ŞIRNAK", value: "ŞIRNAK" },
    { text: "BARTIN", value: "BARTIN" },
    { text: "ARDAHAN", value: "ARDAHAN" },
    { text: "IĞDIR", value: "IĞDIR" },
    { text: "YALOVA", value: "YALOVA" },
    { text: "KARABÜK", value: "KARABÜK" },
    { text: "KİLİS", value: "KİLİS" },
    { text: "OSMANİYE", value: "OSMANİYE" },
    { text: "DÜZCE", value: "DÜZCE" },
  ],
];
