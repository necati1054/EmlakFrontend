  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (Object.keys(editIlanData).length == 0) {
        ...
        axios
          .post(`/is_yeri/${editIlanData.id}`, formData, {
            headers: { "Content-Type": "multipart/form-data" },
          })
          .then((res) => {
            console.log(res);
  ...
  useEffect(() => {
    if (Object.keys(editIlanData).length != 0) {
      formik.setValues({
        ...
        m2: editIlanData.m2,
        bölüm_oda_sayisi: editIlanData.bölüm_oda_sayisi,
        açık_alan_m2: editIlanData.açık_alan_m2,
        giriş_yüksekliği: editIlanData.giriş_yüksekliği,
        kapalı_alan_m2: editIlanData.kapalı_alan_m2,
        oda_sayisi: editIlanData.oda_sayisi,
        yapı_tipi: editIlanData.yapı_tipi,
        yapı_durumu: editIlanData.yapı_durumu,
        ...
        asansör_sayisi: editIlanData.asansör_sayisi,
        ...
        durumu: editIlanData.durumu,
        İl: editIlanData.İl,
        İlçe: editIlanData.İlçe,
        Mahalle: editIlanData.Mahalle,
        lat: editIlanData.lat,
        lng: editIlanData.lng,
        alkol_ruhsatı: editIlanData.alkol_ruhsatı == 1 ? true : false,
        kiracılı: editIlanData.kiracılı == 1 ? true : false,
